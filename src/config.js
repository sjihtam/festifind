// Written by `npm run setup`. You can also edit it by hand.
//
// Safe to commit and safe to ship to the browser: a PKCE Client ID is public by
// design. There is no client secret anywhere in this project.
//
